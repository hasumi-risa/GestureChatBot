...
from .plot3D import plot3D, animate3D
from .poseVisualizer import visualizePose

def CMUPose2KinectData(pose3d, save_mp4=None, save_csv=None, fps=25, isConvert=True):
    """
