...
def LabanKeyframeToScript(idx, time, dur, laban_score):
    ...
    if (len(laban_score) > 4):
        strScript += 'Right Support:' + laban_score[4][0] + ':' + laban_score[4][1] + '\n'
        strScript += 'Left Support:'  + laban_score[5][0] + ':' + laban_score[5][1] + '\n'

    if (len(laban_score) > 6):
        strScript += 'Right Knee:'  + laban_score[6][0] + ':' + laban_score[6][1] + '\n'
        strScript += 'Right Ankle:' + laban_score[7][0] + ':' + laban_score[7][1] + '\n'
        strScript += 'Left Knee:'   + laban_score[8][0] + ':' + laban_score[8][1] + '\n'
        strScript += 'Left Ankle:'  + laban_score[9][0] + ':' + laban_score[9][1] + '\n'
