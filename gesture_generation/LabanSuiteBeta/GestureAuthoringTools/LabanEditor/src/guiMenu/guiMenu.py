...
class guiMenu:
    ...
    def createUIAlgorithm(self):
        ...
        defaultAlgorithmIdx = 0
        if (algorithm == 'total'):
            defaultAlgorithmIdx = 0
        elif (algorithm == 'parallel'):
            defaultAlgorithmIdx = 1
        elif (algorithm == 'naive'):
            defaultAlgorithmIdx = 2
        ...
        self.radioAlgorithm = RadioButtons(self.axRadio, ('Total Energy', 'Parallel Energy', 'Naive (no filter)'), active=defaultAlgorithmIdx)
    ...
    def onClickAlgorithm(self, label):
        ...
        settings.application.applyAlgorithm(algorithm)
