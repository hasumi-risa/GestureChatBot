...
In addition to the six gestures, the sample files contain examples of the three [keyframe extraction methods ***(naive, total, and parallel)*** available for processing in the **LabanEditor**](https://dev.azure.com/msresearch/Robotics/_git/LabanSuiteBeta?path=%2FGestureAuthoringTools%2FLabanEditor%2FREADME.md&version=GBmaster&_a=preview&anchor=keyframe-extraction-algorithms) gesture authoring tool included in this suite.
