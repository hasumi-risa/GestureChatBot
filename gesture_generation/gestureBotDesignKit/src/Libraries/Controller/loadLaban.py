...
class loadLaban():
    ...
    # -----------------------------------------------------------------------------
    #
    def loadGesture(self, folder, fileName, forceLoad = False, audio_path = None):
        #
        # reset
        ...
        data = None
        success = False
        print("self.gesturePath: ", self.gesturePath)
        print("folder: ", folder)
        print("fileName: ", fileName)
        try:
            path = os.path.abspath(os.path.join(self.gesturePath, folder, fileName))
            print("filepath: ", path)
            print("join: ", os.path.join(self.gesturePath, folder, fileName))
