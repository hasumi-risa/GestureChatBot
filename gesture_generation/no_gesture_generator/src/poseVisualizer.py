...
def visualizePose(pose, mode=None, fig_scale=1, index_list=None):
    ...
    elif mode == 'cmu15joint':
        borne_list = [[0,1], [0,2], [0,3], [3,4], [4,5], [2,6], [6,7], [7,8], [0,9], [9,10], [10,11], [2,12], [12,13], [13,14]]
    elif mode == 'upper':
        borne_list = [[0, 1], [0, 3], [3, 4], [4, 5], [0, 9], [9, 10], [10, 11]]
    elif mode == 'kinect':
        borne_list = [[0,1], [1,20], [20,2], [20,4], [4,5], [5,6], [20,8], [8,9], [9,10], [0,12], [12,13], [13,14], [0,16], [16,17], [17,18]]
