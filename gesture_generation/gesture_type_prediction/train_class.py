...
train_iter = createDataLoader(data_dir + 'train_{}.pth'.format(option1 + '_balanced'))
valid_iter = createDataLoader(data_dir + 'valid_class.pth'.format(option1))
    ...
    for epoch in range(num_epochs):
        ...
        for text, labels in train_loader:
            ...
            for i in range(len(output)):
                ...
                lab = removePadding(text[i], labels[i]).long()
